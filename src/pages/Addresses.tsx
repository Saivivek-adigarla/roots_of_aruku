    ...
    <div className="max-w-4xl mx-auto px-4 py-8">
      <div className="flex items-center justify-between mb-6">
        ...
        <button
          ...
          className="flex items-center gap-1 bg-maroon-700 text-white px-4 py-2 rounded-lg font-medium hover:bg-maroon-800"
        >
      ...
      {addresses.length === 0 && !showForm ? (
        <div className="text-center py-16 bg-white rounded-xl border border-gray-100">
          ...
          <button onClick={() => setShowForm(true)} className="bg-maroon-700 text-white px-6 py-2 rounded-lg font-medium">
            Add Address
          </button>
        </div>
      ) : (
              ...
              <div className="flex justify-between">
                ...
                <div className="flex gap-2">
                  <button
                    ...
                    className="p-2 text-gray-500 hover:text-maroon-700 hover:bg-maroon-50 rounded-lg transition"
                  >
                    <Edit2 size={18} />
                  </button>
                  <button
