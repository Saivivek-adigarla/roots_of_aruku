    ...
    <div className="pb-12">
      <div className="relative h-80 bg-gradient-to-r from-maroon-700 to-maroon-600 flex items-center justify-center text-center text-white overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <p className="text-xl text-gold-400 mb-6">From the Heartland of Araku Valley</p>
      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
          ...
          <div>
            ...
            <p className="text-gray-600 leading-relaxed mb-4">Nestled in the Eastern Ghats, Araku Valley is home to ancient tribal communities who have cultivated coffee, turmeric, and wild honey for generations. We bring these pristine products directly to your doorstep.</p>
