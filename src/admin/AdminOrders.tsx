...
import { Eye, Truck, CheckCircle, XCircle, RotateCcw, Filter } from 'lucide-react';
...
const STATUS_OPTIONS = [
  ...
  { value: 'refunded', label: 'Refunded', color: 'bg-purple-100 text-purple-700', icon: RotateCcw },
];
