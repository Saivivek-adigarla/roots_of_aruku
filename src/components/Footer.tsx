        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-6">
          ...
          <div>
            ...
            <div className="space-y-1 text-sm flex flex-col gap-1">
              ...
              <div className="flex items-center gap-1"><MapPin size={14} /> Araku Valley, Andhra Pradesh</div>
            </div>
          </div>
        </div>
        <div className="border-t border-maroon-800 pt-4 text-center text-xs">&copy; 2025 Roots of Araku. All rights reserved.</div>
      </div>
    </footer>
  );
}
